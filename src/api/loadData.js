...
import { validateAois, validateMetrics, validateScenes, validateWaterPoints } from "./schema.js";

const LOADERS = {
  aois: { path: "aois.geojson", validate: validateAois },
  waterPoints: { path: "water_points.geojson", validate: validateWaterPoints },
