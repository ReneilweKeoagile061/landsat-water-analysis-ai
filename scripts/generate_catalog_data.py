"""Generate SYNTHETIC DEMO frontend catalog data for the Landsat dashboard.

WARNING: All 2,500 water points and associated metrics generated by this script
are randomly simulated demonstration data (seeded with random.Random(42)).
They do NOT represent real Landsat satellite observations or verified boreholes.
Do NOT ship these exports as real data. Replace with real pipeline output before
...
def generate_metrics(scenes: list[dict], points: dict) -> dict:
    ...
    return {
        ...
        "is_demo_data": True,
        "demo_data_warning": (
            "⚠ DEMO DATA: All 2,500 water points are randomly simulated "
            "and do NOT represent real Landsat observations or verified boreholes. "
            "Replace public/data/exports/ with real pipeline output before any deployment."
        ),
    }
...
def export_catalog(output_dir: Path) -> None:
    print("=" * 72)
    print("WARNING: export_catalog() generates 100% SYNTHETIC DEMO DATA.")
    print("All 2,500 water points are randomly simulated (seed=42).")
    print("They do NOT represent real Landsat observations or boreholes.")
    print("Do NOT deploy these exports publicly without replacing with real data.")
    print("=" * 72)
    ...
    print("WARNING: All exported data is synthetic demonstration data — see metrics.json is_demo_data flag.")
